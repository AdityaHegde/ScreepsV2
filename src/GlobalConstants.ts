...
const REFERENCED_GLOBALS = {
  POWER_INFO: {
    [GLOBALS.PWR_GENERATE_OPS]: {
      className: GLOBALS.POWER_CLASS.OPERATOR,
      level: [0, 2, 7, 14, 22],
      cooldown: 50,
      effect: [1, 2, 4, 6, 8]
    },
    [GLOBALS.PWR_OPERATE_SPAWN]: {
      className: GLOBALS.POWER_CLASS.OPERATOR,
      level: [0, 2, 7, 14, 22],
      cooldown: 300,
      duration: 1000,
    ...
    [GLOBALS.PWR_OPERATE_CONTROLLER]: {
      className: GLOBALS.POWER_CLASS.OPERATOR,
      level: [20, 21, 22, 23, 24],
      cooldown: 800,
      range: 3,
  ...
  BODYPARTS_ALL: [
    ...
    GLOBALS.CARRY,
    GLOBALS.ATTACK,
    GLOBALS.RANGED_ATTACK,
    GLOBALS.TOUGH,
    GLOBALS.HEAL,
    GLOBALS.CLAIM
  ],
  RESOURCES_ALL: [
    GLOBALS.RESOURCE_ENERGY,
    GLOBALS.RESOURCE_POWER,

    GLOBALS.RESOURCE_HYDROGEN,
    GLOBALS.RESOURCE_OXYGEN,
    GLOBALS.RESOURCE_UTRIUM,
    GLOBALS.RESOURCE_KEANIUM,
    GLOBALS.RESOURCE_LEMERGIUM,
    GLOBALS.RESOURCE_ZYNTHIUM,
    GLOBALS.RESOURCE_CATALYST,
    GLOBALS.RESOURCE_GHODIUM,

    GLOBALS.RESOURCE_HYDROXIDE,
    GLOBALS.RESOURCE_ZYNTHIUM_KEANITE,
    GLOBALS.RESOURCE_UTRIUM_LEMERGITE,

    GLOBALS.RESOURCE_UTRIUM_HYDRIDE,
    GLOBALS.RESOURCE_UTRIUM_OXIDE,
    GLOBALS.RESOURCE_KEANIUM_HYDRIDE,
    GLOBALS.RESOURCE_KEANIUM_OXIDE,
    GLOBALS.RESOURCE_LEMERGIUM_HYDRIDE,
    GLOBALS.RESOURCE_LEMERGIUM_OXIDE,
    GLOBALS.RESOURCE_ZYNTHIUM_HYDRIDE,
    GLOBALS.RESOURCE_ZYNTHIUM_OXIDE,
    GLOBALS.RESOURCE_GHODIUM_HYDRIDE,
    GLOBALS.RESOURCE_GHODIUM_OXIDE,

    GLOBALS.RESOURCE_UTRIUM_ACID,
    GLOBALS.RESOURCE_UTRIUM_ALKALIDE,
    GLOBALS.RESOURCE_KEANIUM_ACID,
    GLOBALS.RESOURCE_KEANIUM_ALKALIDE,
    GLOBALS.RESOURCE_LEMERGIUM_ACID,
    GLOBALS.RESOURCE_LEMERGIUM_ALKALIDE,
    GLOBALS.RESOURCE_ZYNTHIUM_ACID,
    GLOBALS.RESOURCE_ZYNTHIUM_ALKALIDE,
    GLOBALS.RESOURCE_GHODIUM_ACID,
    GLOBALS.RESOURCE_GHODIUM_ALKALIDE,

    GLOBALS.RESOURCE_CATALYZED_UTRIUM_ACID,
    GLOBALS.RESOURCE_CATALYZED_UTRIUM_ALKALIDE,
    GLOBALS.RESOURCE_CATALYZED_KEANIUM_ACID,
    GLOBALS.RESOURCE_CATALYZED_KEANIUM_ALKALIDE,
    GLOBALS.RESOURCE_CATALYZED_LEMERGIUM_ACID,
    GLOBALS.RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE,
    GLOBALS.RESOURCE_CATALYZED_ZYNTHIUM_ACID,
    GLOBALS.RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE,
    GLOBALS.RESOURCE_CATALYZED_GHODIUM_ACID,
    GLOBALS.RESOURCE_CATALYZED_GHODIUM_ALKALIDE,

    GLOBALS.RESOURCE_OPS,

    GLOBALS.RESOURCE_SILICON,
    GLOBALS.RESOURCE_METAL,
    GLOBALS.RESOURCE_BIOMASS,
    GLOBALS.RESOURCE_MIST,

    GLOBALS.RESOURCE_UTRIUM_BAR,
    GLOBALS.RESOURCE_LEMERGIUM_BAR,
    GLOBALS.RESOURCE_ZYNTHIUM_BAR,
    GLOBALS.RESOURCE_KEANIUM_BAR,
    GLOBALS.RESOURCE_GHODIUM_MELT,
    GLOBALS.RESOURCE_OXIDANT,
    GLOBALS.RESOURCE_REDUCTANT,
    GLOBALS.RESOURCE_PURIFIER,
    GLOBALS.RESOURCE_BATTERY,
    GLOBALS.RESOURCE_COMPOSITE,
    GLOBALS.RESOURCE_CRYSTAL,
    GLOBALS.RESOURCE_LIQUID,

    GLOBALS.RESOURCE_WIRE,
    GLOBALS.RESOURCE_SWITCH,
    GLOBALS.RESOURCE_TRANSISTOR,
    GLOBALS.RESOURCE_MICROCHIP,
    GLOBALS.RESOURCE_CIRCUIT,
    GLOBALS.RESOURCE_DEVICE,

    GLOBALS.RESOURCE_CELL,
    GLOBALS.RESOURCE_PHLEGM,
    GLOBALS.RESOURCE_TISSUE,
    GLOBALS.RESOURCE_MUSCLE,
    GLOBALS.RESOURCE_ORGANOID,
    GLOBALS.RESOURCE_ORGANISM,

    GLOBALS.RESOURCE_ALLOY,
    GLOBALS.RESOURCE_TUBE,
    GLOBALS.RESOURCE_FIXTURES,
    GLOBALS.RESOURCE_FRAME,
    GLOBALS.RESOURCE_HYDRAULICS,
    GLOBALS.RESOURCE_MACHINE,

    GLOBALS.RESOURCE_CONDENSATE,
    GLOBALS.RESOURCE_CONCENTRATE,
    GLOBALS.RESOURCE_EXTRACT,
    GLOBALS.RESOURCE_SPIRIT,
    GLOBALS.RESOURCE_EMANATION,
    GLOBALS.RESOURCE_ESSENCE
  ],
  COLORS_ALL: [
    GLOBALS.COLOR_RED,
    GLOBALS.COLOR_PURPLE,
    GLOBALS.COLOR_BLUE,
    GLOBALS.COLOR_CYAN,
    GLOBALS.COLOR_GREEN,
    GLOBALS.COLOR_YELLOW,
    GLOBALS.COLOR_ORANGE,
    GLOBALS.COLOR_BROWN,
    GLOBALS.COLOR_GREY,
    GLOBALS.COLOR_WHITE
  ],
  INTERSHARD_RESOURCES: [
    GLOBALS.SUBSCRIPTION_TOKEN,
    GLOBALS.CPU_UNLOCK,
    GLOBALS.PIXEL,
    GLOBALS.ACCESS_KEY
  ],
  COMMODITIES: {
    [GLOBALS.RESOURCE_UTRIUM_BAR]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_UTRIUM]: 500,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_UTRIUM]: {
      amount: 500,
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_UTRIUM_BAR]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_LEMERGIUM_BAR]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_LEMERGIUM]: 500,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_LEMERGIUM]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_LEMERGIUM_BAR]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_ZYNTHIUM_BAR]: {
    ...
    [GLOBALS.RESOURCE_ZYNTHIUM]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_ZYNTHIUM_BAR]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_KEANIUM_BAR]: {
    ...
    [GLOBALS.RESOURCE_KEANIUM]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_KEANIUM_BAR]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_GHODIUM_MELT]: {
    ...
    [GLOBALS.RESOURCE_GHODIUM]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_GHODIUM_MELT]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_OXIDANT]: {
    ...
    [GLOBALS.RESOURCE_HYDROGEN]: {
      ...
      cooldown: 20,
      components: {
        [GLOBALS.RESOURCE_REDUCTANT]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 200
      }
    },
    [GLOBALS.RESOURCE_PURIFIER]: {
    ...
    [GLOBALS.RESOURCE_COMPOSITE]: {
      ...
      cooldown: 50,
      components: {
        [GLOBALS.RESOURCE_UTRIUM_BAR]: 20,
        [GLOBALS.RESOURCE_ZYNTHIUM_BAR]: 20,
        [GLOBALS.RESOURCE_ENERGY]: 20
      }
    },
    [GLOBALS.RESOURCE_CRYSTAL]: {
      level: 2,
      ...
      cooldown: 21,
      components: {
        [GLOBALS.RESOURCE_LEMERGIUM_BAR]: 6,
        [GLOBALS.RESOURCE_KEANIUM_BAR]: 6,
        [GLOBALS.RESOURCE_PURIFIER]: 6,
        [GLOBALS.RESOURCE_ENERGY]: 45
      }
    },
    [GLOBALS.RESOURCE_LIQUID]: {
      level: 3,
      ...
      cooldown: 60,
      components: {
        [GLOBALS.RESOURCE_OXIDANT]: 12,
        [GLOBALS.RESOURCE_REDUCTANT]: 12,
        [GLOBALS.RESOURCE_GHODIUM_MELT]: 12,
        [GLOBALS.RESOURCE_ENERGY]: 90
      }
    },
    ...
    [GLOBALS.RESOURCE_WIRE]: {
      ...
      components: {
        [GLOBALS.RESOURCE_UTRIUM_BAR]: 20,
        [GLOBALS.RESOURCE_SILICON]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 40
      }
    },
    [GLOBALS.RESOURCE_SWITCH]: {
      level: 1,
      ...
      cooldown: 70,
      components: {
        [GLOBALS.RESOURCE_WIRE]: 40,
        [GLOBALS.RESOURCE_OXIDANT]: 95,
        [GLOBALS.RESOURCE_UTRIUM_BAR]: 35,
        [GLOBALS.RESOURCE_ENERGY]: 20
      }
    },
    [GLOBALS.RESOURCE_TRANSISTOR]: {
      ...
      cooldown: 59,
      components: {
        [GLOBALS.RESOURCE_SWITCH]: 4,
        [GLOBALS.RESOURCE_WIRE]: 15,
        [GLOBALS.RESOURCE_REDUCTANT]: 85,
        [GLOBALS.RESOURCE_ENERGY]: 8
      }
    },
    [GLOBALS.RESOURCE_MICROCHIP]: {
      level: 3,
      ...
      cooldown: 250,
      components: {
        [GLOBALS.RESOURCE_TRANSISTOR]: 2,
        [GLOBALS.RESOURCE_COMPOSITE]: 50,
        [GLOBALS.RESOURCE_WIRE]: 117,
        [GLOBALS.RESOURCE_PURIFIER]: 25,
        [GLOBALS.RESOURCE_ENERGY]: 16
      }
    },
    [GLOBALS.RESOURCE_CIRCUIT]: {
      level: 4,
      ...
      cooldown: 800,
      components: {
        [GLOBALS.RESOURCE_MICROCHIP]: 1,
        [GLOBALS.RESOURCE_TRANSISTOR]: 5,
        [GLOBALS.RESOURCE_SWITCH]: 4,
        [GLOBALS.RESOURCE_OXIDANT]: 115,
        [GLOBALS.RESOURCE_ENERGY]: 32
      }
    },
    [GLOBALS.RESOURCE_DEVICE]: {
      level: 5,
      ...
      cooldown: 600,
      components: {
        [GLOBALS.RESOURCE_CIRCUIT]: 1,
        [GLOBALS.RESOURCE_MICROCHIP]: 3,
        [GLOBALS.RESOURCE_CRYSTAL]: 110,
        [GLOBALS.RESOURCE_GHODIUM_MELT]: 150,
        [GLOBALS.RESOURCE_ENERGY]: 64
      }
    },
    ...
    [GLOBALS.RESOURCE_CELL]: {
      ...
      cooldown: 8,
      components: {
        [GLOBALS.RESOURCE_LEMERGIUM_BAR]: 20,
        [GLOBALS.RESOURCE_BIOMASS]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 40
      }
    },
    [GLOBALS.RESOURCE_PHLEGM]: {
      ...
      cooldown: 35,
      components: {
        [GLOBALS.RESOURCE_CELL]: 20,
        [GLOBALS.RESOURCE_OXIDANT]: 36,
        [GLOBALS.RESOURCE_LEMERGIUM_BAR]: 16,
        [GLOBALS.RESOURCE_ENERGY]: 8
      }
    },
    [GLOBALS.RESOURCE_TISSUE]: {
      ...
      cooldown: 164,
      components: {
        [GLOBALS.RESOURCE_PHLEGM]: 10,
        [GLOBALS.RESOURCE_CELL]: 10,
        [GLOBALS.RESOURCE_REDUCTANT]: 110,
        [GLOBALS.RESOURCE_ENERGY]: 16
      }
    },
    [GLOBALS.RESOURCE_MUSCLE]: {
      ...
      cooldown: 250,
      components: {
        [GLOBALS.RESOURCE_TISSUE]: 3,
        [GLOBALS.RESOURCE_PHLEGM]: 3,
        [GLOBALS.RESOURCE_ZYNTHIUM_BAR]: 50,
        [GLOBALS.RESOURCE_REDUCTANT]: 50,
        [GLOBALS.RESOURCE_ENERGY]: 16
      }
    },
    [GLOBALS.RESOURCE_ORGANOID]: {
      ...
      cooldown: 800,
      components: {
        [GLOBALS.RESOURCE_MUSCLE]: 1,
        [GLOBALS.RESOURCE_TISSUE]: 5,
        [GLOBALS.RESOURCE_PURIFIER]: 208,
        [GLOBALS.RESOURCE_OXIDANT]: 256,
        [GLOBALS.RESOURCE_ENERGY]: 32
      }
    },
    [GLOBALS.RESOURCE_ORGANISM]: {
      ...
      cooldown: 600,
      components: {
        [GLOBALS.RESOURCE_ORGANOID]: 1,
        [GLOBALS.RESOURCE_LIQUID]: 150,
        [GLOBALS.RESOURCE_TISSUE]: 6,
        [GLOBALS.RESOURCE_CELL]: 310,
        [GLOBALS.RESOURCE_ENERGY]: 64
      }
    },
    ...
    [GLOBALS.RESOURCE_TUBE]: {
      ...
      cooldown: 45,
      components: {
        [GLOBALS.RESOURCE_ALLOY]: 40,
        [GLOBALS.RESOURCE_ZYNTHIUM_BAR]: 16,
        [GLOBALS.RESOURCE_ENERGY]: 8
      }
    },
    [GLOBALS.RESOURCE_FIXTURES]: {
      ...
      cooldown: 115,
      components: {
        [GLOBALS.RESOURCE_COMPOSITE]: 20,
        [GLOBALS.RESOURCE_ALLOY]: 41,
        [GLOBALS.RESOURCE_OXIDANT]: 161,
        [GLOBALS.RESOURCE_ENERGY]: 8
      }
    },
    [GLOBALS.RESOURCE_FRAME]: {
      ...
      cooldown: 125,
      components: {
        [GLOBALS.RESOURCE_FIXTURES]: 2,
        [GLOBALS.RESOURCE_TUBE]: 4,
        [GLOBALS.RESOURCE_REDUCTANT]: 330,
        [GLOBALS.RESOURCE_ZYNTHIUM_BAR]: 31,
        [GLOBALS.RESOURCE_ENERGY]: 16
      }
    },
    [GLOBALS.RESOURCE_HYDRAULICS]: {
      ...
      components: {
        [GLOBALS.RESOURCE_LIQUID]: 150,
        [GLOBALS.RESOURCE_FIXTURES]: 3,
        [GLOBALS.RESOURCE_TUBE]: 15,
        [GLOBALS.RESOURCE_PURIFIER]: 208,
        [GLOBALS.RESOURCE_ENERGY]: 32
      }
    },
    [GLOBALS.RESOURCE_MACHINE]: {
      ...
      cooldown: 600,
      components: {
        [GLOBALS.RESOURCE_HYDRAULICS]: 1,
        [GLOBALS.RESOURCE_FRAME]: 2,
        [GLOBALS.RESOURCE_FIXTURES]: 3,
        [GLOBALS.RESOURCE_TUBE]: 12,
        [GLOBALS.RESOURCE_ENERGY]: 64
      }
    },
    ...
    [GLOBALS.RESOURCE_CONDENSATE]: {
      ...
      cooldown: 8,
      components: {
        [GLOBALS.RESOURCE_KEANIUM_BAR]: 20,
        [GLOBALS.RESOURCE_MIST]: 100,
        [GLOBALS.RESOURCE_ENERGY]: 40
      }
    },
    [GLOBALS.RESOURCE_CONCENTRATE]: {
      ...
      cooldown: 41,
      components: {
        [GLOBALS.RESOURCE_CONDENSATE]: 30,
        [GLOBALS.RESOURCE_KEANIUM_BAR]: 15,
        [GLOBALS.RESOURCE_REDUCTANT]: 54,
        [GLOBALS.RESOURCE_ENERGY]: 12
      }
    },
    [GLOBALS.RESOURCE_EXTRACT]: {
      level: 2,
      ...
      cooldown: 128,
      components: {
        [GLOBALS.RESOURCE_CONCENTRATE]: 10,
        [GLOBALS.RESOURCE_CONDENSATE]: 30,
        [GLOBALS.RESOURCE_OXIDANT]: 60,
        [GLOBALS.RESOURCE_ENERGY]: 16
      }
    },
    [GLOBALS.RESOURCE_SPIRIT]: {
      ...
      cooldown: 200,
      components: {
        [GLOBALS.RESOURCE_EXTRACT]: 2,
        [GLOBALS.RESOURCE_CONCENTRATE]: 6,
        [GLOBALS.RESOURCE_REDUCTANT]: 90,
        [GLOBALS.RESOURCE_PURIFIER]: 20,
        [GLOBALS.RESOURCE_ENERGY]: 16
      }
    },
    [GLOBALS.RESOURCE_EMANATION]: {
      ...
      cooldown: 800,
      components: {
        [GLOBALS.RESOURCE_SPIRIT]: 2,
        [GLOBALS.RESOURCE_EXTRACT]: 2,
        [GLOBALS.RESOURCE_CONCENTRATE]: 3,
        [GLOBALS.RESOURCE_KEANIUM_BAR]: 112,
        [GLOBALS.RESOURCE_ENERGY]: 32
      }
    },
    [GLOBALS.RESOURCE_ESSENCE]: {
      ...
      cooldown: 600,
      components: {
        [GLOBALS.RESOURCE_EMANATION]: 1,
        [GLOBALS.RESOURCE_SPIRIT]: 3,
        [GLOBALS.RESOURCE_CRYSTAL]: 110,
        [GLOBALS.RESOURCE_GHODIUM_MELT]: 150,
        [GLOBALS.RESOURCE_ENERGY]: 64
      }
...
for (const g in REFERENCED_GLOBALS) {
  global[g] = REFERENCED_GLOBALS[g];
}
