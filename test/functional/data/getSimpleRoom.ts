...
export async function getSimpleRoom(server: any, roomName: string): Promise<void> {
  ...
  await server.world.addRoomObject(roomName, "source", 10, 40, { energy: 3000, energyCapacity: 3000, ticksToRegeneration: 300 });
  await server.world.addRoomObject(roomName, "source", 40, 10, { energy: 3000, energyCapacity: 3000, ticksToRegeneration: 300 });
